...
int main(int argc, char *argv[])
{
    ...
    parm.seed->description =
        _("The same seed reproduces the results for any number of threads");
    ...
    /* The walkers draw from streams of their own, seeded with this value in
     * main_loop(), not from the shared generator; G_srand48_auto() is
     * called only for the seed it derives. */
