...
if(WITH_FHS)
  ...
  # Prefix-relative so that both the staged runtime tree under OUTDIR and
  # the installed tree stay inside their respective roots. Absolute
  # Python3_SITEARCH would escape CMAKE_INSTALL_PREFIX on install.
  if(NOT DEFINED GRASS_INSTALL_PYDIR)
    set(GRASS_INSTALL_PYDIR
  ...
  set(GRASS_INSTALL_GUIRESDIR "${GRASS_INSTALL_GUIDIR}")
...
if(IS_ABSOLUTE "${GRASS_INSTALL_PYDIR}")
  message(
    FATAL_ERROR
      "GRASS_INSTALL_PYDIR must be relative to the install prefix, got: "
      "${GRASS_INSTALL_PYDIR}")
endif()
...
message(STATUS "GRASS_INSTALL_GUIRESDIR ${GRASS_INSTALL_GUIRESDIR}")
...
set(GRASS_LIBDIR "${GRASS_INSTALL_LIBDIR}")
set(GRASS_LOCALEDIR "${GRASS_INSTALL_LOCALEDIR}")
set(GRASS_MANDIR "${GRASS_INSTALL_MANDIR}")
set(GRASS_GUIRESDIR "${GRASS_INSTALL_GUIRESDIR}")
set(GRASS_GUIXMLDIR "${GRASS_INSTALL_GUIRESDIR}/wxpython/xml")
...
set(RUNTIME_GRASS_GUIRESDIR "${OUTDIR}/${GRASS_INSTALL_GUIRESDIR}")
set(RUNTIME_GRASS_GUIXMLDIR "${OUTDIR}/${GRASS_INSTALL_GUIRESDIR}/wxpython/xml")
...
file(TO_NATIVE_PATH "${CMAKE_INSTALL_PREFIX}/${GRASS_INSTALL_PYDIR}"
     GRASS_INSTALL_PYDIR_PATH)
file(TO_NATIVE_PATH "${OUTDIR}/${GRASS_INSTALL_PYDIR}"
...
message("Creating directories in ${OUTDIR}")
...
file(MAKE_DIRECTORY "${OUTDIR}/${GRASS_INSTALL_GUIRESDIR}/wxpython/xml")
file(MAKE_DIRECTORY "${OUTDIR}/${GRASS_INSTALL_GUIRESDIR}/icons")
file(MAKE_DIRECTORY "${OUTDIR}/${GRASS_INSTALL_GUIRESDIR}/images")
